        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOpenTelemetry()
                .ConfigureResource(resource => resource
                    .AddService("cartservice", serviceVersion: "1.0.0")
                    .AddAttributes(new[] { new System.Collections.Generic.KeyValuePair<string, object>("deployment.environment", "production") }))
                .WithTracing(tracing => tracing
                    .AddSource("cartservice")
                    .AddAspNetCoreInstrumentation()
                    .AddGrpcClientInstrumentation()
                    .AddOtlpExporter(opt => opt.Endpoint = new Uri(Configuration["OTEL_EXPORTER_OTLP_ENDPOINT"] ?? "http://opentelemetry-collector-agent.default.svc.cluster.local:4317")))
